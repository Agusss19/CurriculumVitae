...
\section{Experiencia}
\cventry{2021--actualidad}{Desarrollador Fullstack}{(.NET Core, React, Redux, NextJS) \href{https://www.fullstacklabs.co/}{Fullstack Labs}}{Remoto}{}{Desarrollo de un sistema para la empresa MGM Resorts en Estados Unidos con el fin de reservar hoteles, habitaciones, shows y entretenimientos a lo largo de los distintos puntos turísticos de USA. El sistema fue construido usando React (Hooks), Redux y NextJS para el Frontend y Apollo (GraphQL) para la comunicación con el Backend. La aplicación está orientada a microfrontends (Webpack 5 - Module Federation), utiliza las últimas técnologías cloud de Azure. Algunos de los componentes utilizados en la solución son Azure Storages y Functions. Para las pruebas se utilizó Jest para los unit tests y Cypress para el E2E. El deploy a los ambientes se realizó utilizando el servicio de Azure DevOps a fin de compilar la solución, ejecutar los unit tests, los de integración y finalmente empaquetar y copiar los archivos resultantes al servidor destino. Se requirió, además, una participación activa en el análisis de los requerimientos del cliente y en la definición de las correspondientes tareas. Incluso se le brindó asesoramiento técnico ante algunas necesidades de negocio particulares. La metodología de desarrollo era Scrum, incluyendo todas las instancias con el cliente: daily, grooming, planning, retrospective.}

\cventry{2020--2021}{Desarrollador Fullstack}{(.NET Core, React, Redux, NextJS) \href{https://uruit.com/}{UruIT}}{Montevideo}{}{Desarrollo de un sistema para la empresa SupremeGolf en Estados Unidos con el fin de vender horas para jugar al golf. El sistema fue construido usando React (Hooks), Redux y NextJS para el Frontend, .NET Core (C\#) para el Backend y el ORM Dapper para la comunicación con la base de datos de SQLServer. La aplicación está orientada a microservicios (CQRS), utiliza las últimas técnologías cloud de Azure y paradigmas tales como DDD e inyección de dependencias. Algunos de los componentes utilizados en la solución son AppServices, Queues, Topics, Funciones y Redis. Para el testing de la aplicación se utilizó Jest en el Frontend y XUnit en el Backend. El deploy a los ambientes se realizó utilizando el servicio de Azure DevOps a fin de compilar la solución, ejecutar los unit tests, los de integración y finalmente empaquetar y copiar los archivos resultantes al servidor destino. Se requirió, además, una participación activa en el análisis de los requerimientos del cliente y en la definición de las correspondientes tareas. Incluso se le brindó asesoramiento técnico ante algunas necesidades de negocio particulares. La metodología de desarrollo era Scrum, incluyendo todas las instancias con el cliente: daily, grooming, planning, retrospective.}
...
\section{Proyectos}
\cventry{2023}{DetailingCarW}{Web}{React}{}{Desarrollo personal de una página Web para una empresa de Estados Unidos que se dedica al lavado y al tratamiento de autos. La aplicación permite que se consulten los diferentes servicios disponibles como asi tambien permite que los mismos sean modificados por el adminsitrador. La aplicación está construida con React, NextJS y Firebase.
\href{http://detailingcarw.com/}{http://detailingcarw.com/}}

\cventry{2023}{SWR}{Web}{React}{}{Desarrollo personal de una librería para React que permite manejar el estado global de la aplicación de una forma eficiente evitando multiples re-renderizados. Está orientada a objetos y guarda cierta similitud con Zustand. La librería está construida con React.
\href{https://github.com/agusmgarcia/react-swr/}{https://github.com/agusmgarcia/react-swr}}

\cventry{2021}{Ingresos Mensuales}{Web}{React}{}{Desarrollo personal de un software que permite registrar tus movimientos de entrada y salida, agrupándolos por categorías. La información se guarda en una base de datos no relacional y luego puede consultarse de diferentes maneras gracias a una serie de filtros proporcionados. La aplicación está construida con React, NextJS y Firebase.
\href{https://monthly-incomes.web.app/}{https://monthly-incomes.web.app/}}

\cventry{2021}{Página Personal}{Web}{React}{}{Desarrollo personal de mi página personal donde se listan las distintas compañías en las que estuve trabajando asi como también las tecnologías que manejo. La aplicación está construida con React, NextJS y Firebase.
\href{https://agustin-garcia.web.app/}{https://agustin-garcia.web.app/}}

\section{Idiomas}
\cvitemwithcomment{Nativo}{Español}{}
\cvitemwithcomment{Intermedio-Superior}{Ingles}{}
